...
class NonActive_Stock extends StatefulWidget {
  @override
  State<NonActive_Stock> createState() => _NonActive_StockState();
}

class _NonActive_StockState extends State<NonActive_Stock> {
  List arg = [];
                                    ...
                                    itemBuilder: (context) => [
                                      PopupMenuItem(
                                        onTap: (){
                                          ...
                                          database.updateProductStatus(status: true,docid: burger[index].id.toString()).then((value) {
                                            setState(() {
                                    ...
                                    itemBuilder: (context) => [
                                      PopupMenuItem(
                                        onTap: (){
                                          ...
                                          database.updateProductStatus(status: true,docid: pizza[index].id.toString()).then((value) {
                                            setState(() {
                                    ...
                                    itemBuilder: (context) => [
                                      PopupMenuItem(
                                        onTap: (){
                                          ...
                                          database.updateProductStatus(status: true,docid: snacks[index].id.toString()).then((value) {
                                            setState(() {
                                    ...
                                    itemBuilder: (context) => [
                                      PopupMenuItem(
                                        onTap: (){
                                          ...
                                          database.updateProductStatus(status: true,docid: drinks[index].id.toString()).then((value) {
                                            setState(() {
                                    ...
                                    itemBuilder: (context) => [
                                      PopupMenuItem(
                                        onTap: (){
                                          ...
                                          database.updateProductStatus(status: true,docid: shakes[index].id.toString()).then((value) {
                                            setState(() {
